...
@section('content')
    ...
    <div class="container">
        <form class="form-horizontal" role="form" method="POST" action="{{ route('kontraktas.store') }}">
            @csrf
{{--            {{method_field('PUT')}}--}}
            <div class="form-group row">
                <label for="galiojimo_pradzia" class="col-md-4 control-label">Galioja nuo:</label>
                <input id="galiojimo_pradzia" type="date" class="form-control" name="galiojimo_pradzia" value="">
            </div>
            <div class="form-group row">
                <label for="galiojimo_pabaiga" class="col-md-4 control-label">Galioja iki:</label>
                <input id="galiojimo_pabaiga" type="date" class="form-control" name="galiojimo_pabaiga" value="">
            </div>
            <div class="form-group row">
                <label for="skiriami_pinigai" class="col-md-4 control-label">Skiriami pinigai</label>
                <input id="skiriami_pinigai" type="number" class="form-control" name="skiriami_pinigai" value="">
            </div>
            <div class="form-group row">
